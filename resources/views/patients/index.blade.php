<x-app-layout>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-gray-300 dark:border-gray-700">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                <th class="px-4 py-2 border">Patient No</th>
                                ...
                                <th class="px-4 py-2 border">Emergency</th>
                        ...
                        <tbody>
                            @foreach($patients as $patient)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900">
                                    <td class="px-4 py-2 border font-bold">Patient No {{ $loop->iteration }}</td>
                                    <td class="px-4 py-2 border">{{ $patient->last_name }}, {{ $patient->first_name }} @if($patient->middle_name), {{ $patient->middle_name }}@endif</td>
                                    <td class="px-4 py-2 border">{{ $patient->sex }}</td>
                                    <td class="px-4 py-2 border">{{ $patient->date_of_birth->format('Y-m-d') }}</td>
                                ...
                                <div x-show="openEditId === {{ $patient->id }}" x-cloak
                                    ...
                                    <div class="bg-white p-6 rounded w-1/2 max-h-[90vh] overflow-y-auto">
                                        ...
                                        <form method="POST" action="{{ route('patients.update', $patient->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <input type="text" name="last_name" value="{{ old('last_name', $patient->last_name) }}" class="w-full border p-2 mb-2" placeholder="Last Name" required>
                                            <input type="text" name="first_name" value="{{ old('first_name', $patient->first_name) }}" class="w-full border p-2 mb-2" placeholder="First Name" required>
                                            <input type="text" name="middle_name" value="{{ old('middle_name', $patient->middle_name) }}" class="w-full border p-2 mb-2" placeholder="Middle Name">
                                            <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $patient->date_of_birth->format('Y-m-d')) }}" class="w-full border p-2 mb-2" required>
                                             <input type="int" name="age" value="{{ old('age', $patient->age) }}" class="w-full border p-2 mb-2" placeholder="Age">
                                            <input type="date" name="date_registered" value="{{ old('date_registered', $patient->date_registered->format('Y-m-d')) }}" class="w-full border p-2 mb-2">
    ...
    <option value="CommonLaw" {{ old('civil_status', $patient->civil_status ?? '') == 'Common-Law' ? 'selected' : '' }}>Common-Law</option>
</select>       
                                            <input type="text" name="nationality" value="{{ old('nationality', $patient->nationality) }}" class="w-full border p-2 mb-2" placeholder="Nationality">
                                            <input type="text" name="religion" value="{{ old('religion', $patient->religion) }}" class="w-full border p-2 mb-2" placeholder="Religion">
                                            <input type="text" name="occupation" value="{{ old('occupation', $patient->occupation) }}" class="w-full border p-2 mb-2" placeholder="Occupation">
                                            <textarea name="address" class="w-full border p-2 mb-2" placeholder="Address">{{ old('address', $patient->address) }}</textarea>
                                            <input type="text" name="city" value="{{ old('city', $patient->city) }}" class="w-full border p-2 mb-2" placeholder="City">
                                            <input type="text" name="province" value="{{ old('province', $patient->province) }}" class="w-full border p-2 mb-2" placeholder="Province">
                                            <input type="text" name="zip_code" value="{{ old('zip_code', $patient->zip_code) }}" class="w-full border p-2 mb-2" placeholder="Zip Code">
                                            <input type="text" name="mobile_number" value="{{ old('mobile_number', $patient->mobile_number) }}" class="w-full border p-2 mb-2" placeholder="Mobile Number">
                                            <input type="text" name="landline_number" value="{{ old('landline_number', $patient->landline_number) }}" class="w-full border p-2 mb-2" placeholder="Landline Number">
                                            <input type="email" name="email" value="{{ old('email', $patient->email) }}" class="w-full border p-2 mb-2" placeholder="Email">
                                            <input type="text" name="referred_by" value="{{ old('referred_by', $patient->referred_by) }}" class="w-full border p-2 mb-2" placeholder="Referred By">
                                            <input type="text" name="emergency_full_name" value="{{ old('emergency_full_name', $patient->emergencyContact->full_name ?? '') }}" class="w-full border p-2 mb-2" placeholder="Emergency Contact Name" required>
                                            <input type="text" name="emergency_relationship" value="{{ old('emergency_relationship', $patient->emergencyContact->relationship ?? '') }}" class="w-full border p-2 mb-2" placeholder="Relationship">
                                            <input type="text" name="emergency_mobile" value="{{ old('emergency_mobile', $patient->emergencyContact->mobile_number ?? '') }}" class="w-full border p-2 mb-2" placeholder="Emergency Mobile">
                                            <input type="text" name="emergency_landline" value="{{ old('emergency_landline', $patient->emergencyContact->landline_number ?? '') }}" class="w-full border p-2 mb-2" placeholder="Emergency Landline">
...
<div x-show="openAdd" x-cloak
    ...
    <div class="bg-white p-6 rounded w-1/2 max-h-[90vh] overflow-y-auto">
        ...
        <form method="POST" action="{{ route('patients.store') }}">
            ...
            <input type="text" name="last_name" class="w-full border p-2 mb-2" required>
            <label class="block mb-1 font-medium">First Name</label>
            <input type="text" name="first_name" class="w-full border p-2 mb-2" required>
            <label class="block mb-1 font-medium">Middle Name</label>
            <input type="text" name="middle_name" class="w-full border p-2 mb-2">
            ...
            <input type="text" name="age" class="w-full border p-2 mb-2" required>
 ...
 <select name="civil_status" class="w-full border p-2 mb-2" required>
    ...
    <option value="Commonlaw">Common-Law / Live-in</option>
            ...
            <input type="text" name="nationality" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Religion</label>
            <input type="text" name="religion" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Occupation</label>
            <input type="text" name="occupation" class="w-full border p-2 mb-2">
            
          <div class="mb-2">
    <label for="address" class="block font-medium mb-1">Address</label>
    <textarea id="address" name="address" class="w-full border p-2 rounded" rows="2"></textarea>
</div>
            <label class="block mb-1 font-medium">City</label>
            <input type="text" name="city" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Province</label>
            <input type="text" name="province" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Zip Code</label>
            <input type="text" name="zip_code" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Mobile Number</label>
            <input type="text" name="mobile_number" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Landline Number</label>
            <input type="text" name="landline_number" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Email</label>
            <input type="email" name="email" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Referred By</label>
            <input type="text" name="referred_by" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Emergency Contact Name</label>
            <input type="text" name="emergency_full_name" class="w-full border p-2 mb-2" required>
            
            <label class="block mb-1 font-medium">Relationship</label>
            <input type="text" name="emergency_relationship" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Emergency Mobile</label>
            <input type="text" name="emergency_mobile" class="w-full border p-2 mb-2">
            
            <label class="block mb-1 font-medium">Emergency Landline</label>
            <input type="text" name="emergency_landline" class="w-full border p-2 mb-2">
            
            <div class="mt-4 flex justify-end space-x-2">
                <x-secondary-button @click="openAdd = false">Cancel</x-secondary-button>
