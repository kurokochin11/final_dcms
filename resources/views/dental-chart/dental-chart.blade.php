<x-app-layout>
    <div class="py-6" x-data="{ 
        selectedTool: 'check', 
        {{-- Load existing tooth data if editing a session, otherwise empty object --}}
                ...
                <div class="col-span-9 bg-white p-8 rounded-lg shadow border border-gray-200">
                    <div class="border-b-2 border-blue-900 pb-4 mb-6">
                        <div class="flex justify-between items-start">
                            <h2 class="text-2xl font-black text-blue-900 uppercase tracking-widest">Examination Record</h2>
                        ...
                        <div class="grid grid-cols-4 gap-4 mt-6 text-sm">
                            <div class="border-b border-gray-300 pb-1"><strong>Name:</strong> {{ $patient->last_name }}, {{ $patient->first_name }}</div>
                            <div class="border-b border-gray-300 pb-1"><strong>Age:</strong> {{ $patient->age }}</div>
                            <div class="border-b border-gray-300 pb-1"><strong>Sex:</strong> {{ $patient->sex }}</div>
                            <div class="border-b border-gray-300 pb-1"><strong>Occupation:</strong> {{ $patient->occupation }}</div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-row gap-8">
                            ...
                            <div class="w-2/3">
                                ...
                                <div class="mt-8 flex justify-between items-center">
                                    @if(isset($currentSession))
                                        <button type="button" onclick="confirmDelete({{ $currentSession->id }})" class="text-red-600 text-xs font-bold hover:underline">Delete This Session</button>
                                    @else
                                        <div></div>
                                    @endif
