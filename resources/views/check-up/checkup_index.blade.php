...
<x-app-layout>
    ...
    <div class="dental-checkup py-6" x-data="{ 
        step: 1,
        pain: 'No',
        prevTreatment: 'No',
        hygieneAids: 'No'
            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('check-up.store', $patient->id) }}">
                    ...
                    <div x-show="step === 1" x-cloak x-transition>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 flex gap-4">
                                <label><input type="radio" name="checkup_questions[42]" value="Yes" x-model="pain"> Yes</label>
                                <label><input type="radio" name="checkup_questions[42]" value="No" x-model="pain"> No</label>
                            </div>
                            <input type="text" name="checkup_questions[43]" 
                                   placeholder="If yes, location and duration"
                                   :disabled="pain === 'No'"
                                   :class="pain === 'No' ? 'bg-gray-100 opacity-50 cursor-not-allowed' : 'bg-white'"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 flex gap-4">
                                <label><input type="radio" name="checkup_questions[44]" value="Yes" x-model="prevTreatment"> Yes</label>
                                <label><input type="radio" name="checkup_questions[44]" value="No" x-model="prevTreatment"> No</label>
                            </div>
                            <input type="text" name="checkup_questions[45]" 
                                   placeholder="Please specify and approximate dates"
                                   :disabled="prevTreatment === 'No'"
                                   :class="prevTreatment === 'No' ? 'bg-gray-100 opacity-50 cursor-not-allowed' : 'bg-white'"
                                   class="mt-2 block w-full border rounded p-2">
                        </div>
                    ...
                    <div x-show="step === 2" x-cloak x-transition>
                        ...
                        <div class="mb-4">
                            <label class="block font-medium">• Have you noticed any clicking, popping, or pain in your jaw (TMJ)?</label>
                            <div class="mt-1 flex gap-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 flex gap-4">
                                <label><input type="radio" name="checkup_questions[53]" value="Yes" x-model="hygieneAids"> Yes</label>
                                <label><input type="radio" name="checkup_questions[53]" value="No" x-model="hygieneAids"> No</label>
                            </div>
                        </div>

                        <div class="flex justify-between mt-6">
                            <button type="button" @click="step = 1"
                                    class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded shadow">
                                Back
                            </button>
                    ...
                    <div x-show="step === 3" x-cloak x-transition>
                        ...
                        <div class="flex justify-between mt-6">
                            ...
                            <button type="submit"
                                    class="bg-green-600 hover:bg-green-700 text-white px-8 py-2 rounded shadow">
                                Save Results
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex justify-center space-x-3">
                    <template x-for="i in 3">
                        <span class="w-3 h-3 rounded-full cursor-pointer"
                              :class="step === i ? 'bg-blue-600' : 'bg-gray-400'"
                              @click="step = i"></span>
                    </template>
                </div>
