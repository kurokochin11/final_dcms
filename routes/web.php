...
Route::post('/medical-history/{patient}', [MedicalHistoryController::class, 'store'])
 ...
 Route::get('/medical-history/pdf/{session}', [MedicalHistoryController::class, 'downloadMedicalPdf'])
    ->name('medical-history.medical_pdf');
...
// Dental Chart routes
Route::get('/patients/{patient}/dental-history', [DentalChartController::class, 'index'])
        ->name('dental-chart.index');

    Route::get('/patients/{patient}/dental-chart/new', [DentalChartController::class, 'create'])
        ->name('dental-chart.create');

    Route::post('/patients/{patient}/dental-chart', [DentalChartController::class, 'store'])
        ->name('dental-chart.store');

    Route::get('/patients/{patient}/dental-chart/{dentalChart}', [DentalChartController::class, 'show'])
        ->name('dental-chart.show');

    Route::put('/dental-chart/{dentalChart}', [DentalChartController::class, 'update'])
        ->name('dental-chart.update');
